...
prompt Created on יום ראשון 07 יולי 2024 by Tamar
set feedback off
set define off
...
alter table ORDERS disable constraint SYS_C007225;
alter table ORDERS disable constraint SYS_C007226;
alter table ORDERS disable constraint SYS_C007227;
prompt Disabling foreign key constraints for LAUNDRY...
alter table LAUNDRY disable constraint SYS_C007241;
prompt Disabling foreign key constraints for PAYMENT...
alter table PAYMENT disable constraint SYS_C007235;
...
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (119, 'Wayman-Baker', 'wayman.baker@so', '2270586717', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (256, 'Alicia-Creek', 'alicia.c@target', '3712472533', 30);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (52, 'Martha-Whitwam', 'martha.whitwam@', '1441117242', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (756, 'Hope-Capshaw', 'hope.capshaw@ca', '28838152', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (63, 'Gavin-McCain', 'g.mccain@oriser', '2330652643', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (959, 'Joan-Guest', 'joan@generalmot', '3062052741', 40);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (420, 'Liquid-Marsden', 'l.marsden@taste', '850074985', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (575, 'Noah-Bugnon', 'noah.b@spinnake', '2451008547', 40);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (551, 'Julie-Horizon', 'julieh@insurmar', '3762714280', 30);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (755, 'Kate-Magnuson', 'kate.m@logistic', '1029865395', 30);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (428, 'Kate-Wine', 'kate.wine@nmr.c', '761048004', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (138, 'Amanda-Thewlis', 'amanda.thewlis@', '913752806', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (861, 'Philip-England', 'philip.england@', '782555660', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (121, 'Brian-Hudson', 'bhudson@catamou', '1757587950', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (84, 'Lindsay-Keener', 'lindsay.keener@', '2984494320', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (166, 'Lynette-Playboy', 'lynette.p@volks', '1224495102', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (791, 'Rebecca-Deejay', 'rebecca@viacom.', '2452463459', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (617, 'Madeline-Potter', 'madeline.potter', '624120968', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (11, 'Rascal-Withers', 'rascal.withers@', '3668236870', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (281, 'Kenny-Flack', 'kenny.f@ksj.com', '2320995528', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (770, 'Radney-Tinsley', 'radney.tinsley@', '2995648440', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (14, 'Kyle-Wincott', 'kyle@tilia.com', '3979541254', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (30, 'Eddie-Meniketti', 'eddie.meniketti', '2283995079', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (983, 'Christina-Whitm', 'christina.whitm', '2384598262', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (936, 'Armand-Singh', 'armand.singh@we', '1456514642', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (437, 'Boz-Rodriguez', 'boz@studiobprod', '2614273188', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (151, 'Gary-Young', 'gary.young@mast', '3666213741', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (806, 'Bridgette-Green', 'bridgetteg@dsp.', '2217515395', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (70, 'Philip-Braugher', 'philip.braugher', '3123074303', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (659, 'Herbie-Scheider', 'herbie.scheider', '3488135319', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (767, 'Lynn-LaSalle', 'llasalle@telech', '647181112', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (743, 'Shelby-Numan', 'shelby@electric', '824714998', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (919, 'Machine-Leachma', 'machine.leachma', '1639049548', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (268, 'William-Fiennes', 'william.fiennes', '2257265079', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (521, 'Busta-Wiest', 'busta.wiest@3ts', '1080789092', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (170, 'Temuera-Colton', 'temuerac@micros', '679560738', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (104, 'Leslie-Stamp', 'l.stamp@efcbanc', '3674894175', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (632, 'Kenny-Coburn', 'kennyc@nike.com', '3132640080', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (375, 'Lara-Ramirez', 'lramirez@epamsy', '545568228', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (53, 'Natacha-Collie', 'natacha.c@everg', '4226552235', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (399, 'Cledus-Phifer', 'cledus.phifer@m', '2840670431', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (292, 'Anthony-Shatner', 'anthony.shatner', '1391037383', 30);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (895, 'Morgan-Bates', 'morgan.bates@sm', '4256551174', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (231, 'Charlie-Sedaka', 'csedaka@kiamoto', '3037903540', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (769, 'Cyndi-Latifah', 'cyndi.latifah@u', '2144330714', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (754, 'Naomi-Phifer', 'nphifer@gdi.ca', '4231482438', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (177, 'Julie-Karyo', 'julie.karyo@sys', '1434393075', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (402, 'Sean-Bello', 'seanb@adeasolut', '3374871786', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (783, 'Crispin-Estevez', 'cestevez@wci.co', '3809789055', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (69, 'Marianne-Lauper', 'marianne.l@albe', '1100855486', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (377, 'Catherine-Butle', 'catherine.butle', '3355041267', 30);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (162, 'Danni-Herndon', 'danni.herndon@g', '2922015841', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (759, 'Cuba-Costner', 'cuba.costner@am', '3990670701', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (276, 'Jennifer-Krumho', 'jennifer.krumho', '2821483143', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (73, 'Clint-Steagall', 'csteagall@cmi.d', '1142929992', 40);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (693, 'Karon-Heston', 'karon.heston@as', '2943928219', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (491, 'Temuera-Liotta', 't.liotta@bioref', '1161826707', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (777, 'Loreena-Whitmor', 'loreenaw@anwort', '1434215247', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (989, 'Machine-Baez', 'machine.baez@ma', '3370642028', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (689, 'Holland-Bright', 'hbright@ccfhold', '1335265123', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (514, 'Talvin-Patton', 'talvin.patton@p', '1915267541', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (927, 'Sinead-Cervine', 'sinead@proclari', '3748430992', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (209, 'Mae-Nunn', 'mae@terrafirma.', '1148826746', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (224, 'Roberta-Joli', 'robertaj@electr', '1586687188', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (532, 'Vendetta-Marx', 'vendetta.marx@u', '3593280755', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (147, 'Clea-Lucien', 'clea.lucien@exi', '2470266446', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (990, 'Cary-Roy Parnel', 'croyparnell@ame', '3047620441', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (145, 'Emilio-Broza', 'emilio@abs.com', '3596336400', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (357, 'Ruth-Loggins', 'ruthl@cns.za', '3905561554', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (588, 'Clarence-Bates', 'clarence.bates@', '1269479430', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (751, 'Suzanne-Vinton', 'suzanne.vinton@', '1859455150', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (91, 'Glenn-Cash', 'glenn.cash@park', '2545224182', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (620, 'Lea-Palin', 'lea.palin@gener', '4225003621', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (393, 'Willem-Rollins', 'willem@officede', '1253456915', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (9, 'Elle-Levin', 'elle@berkshireh', '653182032', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (598, 'Emerson-Garcia', 'emerson@verizon', '1899343491', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (34, 'Stephanie-Parke', 'stephanie.parke', '1195200980', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (495, 'Maury-Farina', 'maury.farina@us', '1053374057', 30);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (786, 'Tom-Hanks', 'tom.hanks@fetch', '810253289', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (480, 'Davy-Quatro', 'davy.quatro@nta', '923212137', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (198, 'Kenneth-Withers', 'k.witherspoon@k', '891751447', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (216, 'Colleen-Hutton', 'c.hutton@tlsser', '1610119815', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (600, 'Mitchell-Pride', 'mitchell.pride@', '2114553523', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (618, 'Richard-Dunst', 'richard.dunst@a', '3674768993', 50);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (732, 'Queen-Jamal', 'queen.jamal@ams', '3435370038', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (433, 'Miranda-Apple', 'miranda.apple@e', '2720952158', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (565, 'Vern-Cage', 'vern@dillards.d', '3300830969', 30);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (586, 'Judi-Rhames', 'judi@pioneerdat', '1233172289', 30);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (115, 'Emerson-Place', 'emerson@ezecast', '967376656', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (317, 'Chris-Hector', 'chris@greenmoun', '1274844879', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (536, 'Patti-Rea', 'patti.rea@visio', '1610052648', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (345, 'Boyd-Sharp', 'boyd@marlabs.jp', '3253618161', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (916, 'Miranda-Duvall', 'miranda.d@gtp.z', '599140118', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (863, 'Tilda-Fariq', 't.fariq@volkswa', '1192693271', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (71, 'Nelly-Ribisi', 'nelly.ribisi@pr', '3090862295', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (440, 'Luis-Flanagan', 'luis@venoco.com', '4058568726', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (678, 'Carla-Vai', 'carla@kis.uk', '1928840076', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (909, 'Neve-Reed', 'neve.reed@ccfho', '2387187814', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (795, 'Judi-Ramirez', 'judi.ramirez@he', '1570208231', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (867, 'Kurtwood-Madsen', 'kurtwood@bat.co', '2729851058', 0);
commit;
prompt 100 records committed...
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (57, 'Holland-Arquett', 'holland.arquett', '2705307107', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (320, 'Rosanna-Tucker', 'rosanna.tucker@', '1784869904', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (796, 'Jean-Claude-McC', 'jeanclaude.mcca', '1947021888', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (872, 'Winona-White', 'wwhite@generale', '2889396583', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (395, 'Loretta-Rourke', 'lrourke@ataserv', '2642569898', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (301, 'Giancarlo-Tenni', 'giancarlot@flav', '964082871', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (318, 'Collective-Free', 'cfreeman@meridi', '3801500357', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (955, 'Hank-Strong', 'hank.strong@nsd', '3884423418', 30);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (208, 'Nicole-Rucker', 'nicole.rucker@c', '2691197628', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (108, 'Ray-Kline', 'r.kline@grs.com', '1488086880', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (967, 'Alec-Boorem', 'alec.b@linacsys', '1839710812', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (509, 'Jose-Li', 'jli@ogiointerna', '846896267', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (484, 'Dionne-Lachey', 'dionne.lachey@f', '3754847089', 40);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (218, 'Rhona-Perry', 'rhonap@componen', '4005975737', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (772, 'Eileen-Haynes', 'eileen.haynes@n', '535308298', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (501, 'Sarah-Yorn', 'sarah.yorn@aris', '3801333002', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (945, 'Shawn-Renfro', 'shawn.renfro@ma', '3556961100', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (12, 'Garland-Oldman', 'g.oldman@provid', '1932113920', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (508, 'Maceo-Maxwell', 'maceo.maxwell@n', '1895614204', 30);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (382, 'Rene-Dunaway', 'rene.dunaway@mo', '664528874', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (993, 'Yolanda-McDonne', 'ymcdonnell@tech', '3054679165', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (414, 'Casey-Travolta', 'casey.t@gltg.co', '2779830282', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (973, 'Parker-Molina', 'parker.molina@p', '1096686876', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (713, 'Gilbert-Burrows', 'gilbert@mathis.', '3331867031', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (876, 'Reese-Woodard', 'rwoodard@multim', '3048616589', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (76, 'Isaac-Tyson', 'isaac.tyson@spe', '2029994164', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (41, 'Fionnula-Sartai', 'fionnula.sartai', '2592918693', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (1, 'Crystal-Haynes', 'crystal.haynes@', '1492867790', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (545, 'Scott-El-Saher', 'scott.elsaher@c', '2428918053', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (596, 'Harry-Galecki', 'harry.g@horizon', '2373538644', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (18, 'Drew-Skaggs', 'drew@ccb.uk', '1065859559', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (879, 'Nick-Shelton', 'nick.s@target.c', '3194754490', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (481, 'Jill-Neill', 'jill.neill@swi.', '3703090924', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (29, 'Cledus-Vassar', 'cledus.vassar@t', '730734565', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (900, 'Kim-Clooney', 'kimc@virbac.jp', '669946732', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (187, 'Harvey-Bachman', 'harvey.bachman@', '616234840', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (640, 'Uma-Nivola', 'uma.nivola@wrgs', '4043810097', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (441, 'Boyd-Rucker', 'boyd.r@atxforms', '4166236316', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (567, 'Juliana-Snipes', 'julianas@carter', '3600542341', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (784, 'Hikaru-Cleary', 'hikaru.c@mattel', '2065879945', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (595, 'Bonnie-Mattea', 'bmattea@esoftso', '1622123213', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (152, 'Jackson-Coughla', 'jackson.coughla', '1339903322', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (341, 'Grant-Blaine', 'grant.blaine@em', '2152502955', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (352, 'Eileen-Shawn', 'eileen@trinityh', '2686836627', 60);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (842, 'Gaby-Ontiveros', 'gaby@topicsente', '1010850268', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (195, 'Goldie-Gugino', 'goldie.gugino@a', '3405205686', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (389, 'Michelle-Vince', 'mvince@allstar.', '2997357767', 30);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (787, 'Sandra-Giraldo', 'sandra.giraldo@', '1017267070', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (845, 'Lin-MacPherson', 'lin.macpherson@', '18428028', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (485, 'Donal-Harary', 'donal.harary@am', '1226769376', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (38, 'Goran-Heald', 'goran.heald@bri', '3472645645', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (360, 'Nikka-Thurman', 'nikka.thurman@p', '2846927587', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (889, 'Mary-Louise-Man', 'marylouisem@den', '4224062640', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (902, 'Val-Steenburgen', 'val.steenburgen', '3058815776', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (928, 'Radney-Cruise', 'radney@y2market', '2166985774', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (848, 'Joaquim-Jane', 'jjane@netnumina', '2457612996', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (649, 'Grace-Brolin', 'grace.brolin@sp', '2631776471', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (857, 'Mika-Malkovich', 'm.malkovich@mat', '1759481672', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (645, 'Juan-Feore', 'j.feore@gha.com', '4126108396', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (511, 'Naomi-Mahoney', 'n.mahoney@kwraf', '2265481556', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (648, 'Beverley-Costa', 'beverley@author', '31213022', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (311, 'Juliet-Atlas', 'juliet.atlas@ss', '3211049956', 30);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (988, 'Loren-Kapanka', 'loren.kapanka@m', '1159920677', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (765, 'Adrien-Thewlis', 'a.thewlis@hospi', '899719915', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (932, 'Carrie-Edmunds', 'c.edmunds@qls.d', '3756808272', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (303, 'Gary-Checker', 'gary.checker@bi', '1357333059', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (17, 'Chris-Connick', 'cconnick@medsou', '3210634331', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (68, 'Vertical-Belles', 'vertical.belles', '2388370667', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (279, 'Solomon-Uggams', 'solomon.uggams@', '2803639500', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (811, 'Bernard-Bryson', 'bernard.bryson@', '3029730528', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (215, 'Tommy-Aaron', 'tommy.aaron@big', '3469669115', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (942, 'King-Copeland', 'k.copeland@amer', '4083114705', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (302, 'Ted-Magnuson', 'ted@paintedword', '3720365951', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (535, 'Geoffrey-Playbo', 'geoffrey.playbo', '2072259994', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (269, 'Darius-Giannini', 'darius.g@youngi', '637064367', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (930, 'Ike-Forrest', 'ike.forrest@ahl', '1384427922', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (572, 'Treat-Dreyfuss', 'treat.dreyfuss@', '1059643543', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (549, 'Richie-Burke', 'richie@bashen.z', '2775887742', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (23, 'CeCe-Aaron', 'cece.aaron@swi.', '2832466084', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (234, 'Debi-Borden', 'debi.borden@nlx', '2761395904', 30);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (253, 'Eileen-Adkins', 'eadkins@inzone.', '671518750', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (999, 'Dan-Cohen', 'bernie.keithba', '3002526439', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (85, 'Sydney-Bean', 'sydney.bean@ufs', '2731996739', 30);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (469, 'Kitty-Kudrow', 'kitty.kudrow@se', '1472519275', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (964, 'Hope-LaSalle', 'hopel@generalmi', '1155589755', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (808, 'Javon-Deschanel', 'javon.deschanel', '1929539443', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (907, 'Rebeka-Cattrall', 'rebeka.cattrall', '2974964442', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (397, 'Oded-Tate', 'oded@capitolban', '1942705101', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (342, 'Ian-Sepulveda', 'ians@spotfireho', '55137777', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (938, 'Roberta-Roberts', 'robertar@ubp.za', '1768462700', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (738, 'Dabney-Perrinea', 'dabney.p@whitew', '1255527002', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (571, 'Tal-Romijn-Stam', 'tal.romijnstamo', '3684615271', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (677, 'Johnny-Branagh', 'j.branagh@nexxt', '2536970542', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (175, 'Geena-Whitman', 'geena.whitman@c', '1440475633', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (89, 'Freddie-Peet', 'freddie.peet@aq', '1243683319', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (482, 'Isaac-Dalley', 'isaac@gsat.com', '1621455800', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (746, 'Kyra-Garza', 'kyra@iss.ca', '4153835807', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (965, 'Gloria-Kier', 'gkier@smartroni', '4277127489', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (40, 'Juan-Lucas', 'j.lucas@tama.de', '506958119', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (985, 'Rosco-Frampton', 'rosco.frampton@', '1050257418', 10);
commit;
prompt 200 records committed...
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (332, 'Marley-Numan', 'marley.numan@so', '2865209163', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (555, 'Brenda-Tyler', 'btyler@ciwservi', '1179663847', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (523, 'Juan-Connery', 'juan.c@data.fr', '2005505656', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (32, 'Lili-Singh', 'lili.singh@vms.', '3649629659', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (798, 'Loren-Peniston', 'loren.p@sfgo.ca', '1861052875', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (113, 'Keith-Pepper', 'keith.pepper@pr', '4069388170', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (701, 'Lionel-Union', 'lionel@dillards', '2030966712', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (194, 'Molly-Green', 'molly@clorox.fi', '3866383896', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (105, 'Mindy-Myers', 'mindy.myers@ari', '2536523912', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (298, 'Joely-Albright', 'joely.a@ubp.de', '2728929836', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (660, 'Geoff-Numan', 'geoff.numan@sta', '1847243041', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (265, 'Vern-Sarsgaard', 'vern.sarsgaard@', '2118659549', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (830, 'Mena-Kweller', 'mena.k@kitba.co', '2651355106', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (201, 'Jim-Schwarzeneg', 'jim.s@tama.ch', '1068780418', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (764, 'Ani-Sweet', 'ani.sweet@eastm', '3292937838', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (328, 'Dylan-Favreau', 'dylan.favreau@m', '3448773387', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (794, 'Christopher-Hol', 'christopher@aoe', '1937144760', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (72, 'Suzanne-William', 'swilliamson@ass', '1636716192', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (405, 'Michael-Holbroo', 'michaelh@faef.d', '707738883', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (120, 'Lauren-Short', 'lauren.short@ti', '4153236284', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (672, 'Mac-Clarkson', 'mac.clarkson@mc', '3412583186', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (557, 'Lisa-Humphrey', 'lisa.humphrey@g', '1190241922', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (914, 'Catherine-Voigh', 'catherine.voigh', '755017234', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (780, 'Jeffery-Jessee', 'jeffery@fpf.com', '1120525873', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (503, 'Victor-Copeland', 'victor.copeland', '2542669515', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (374, 'Albertina-Roth', 'albertina.roth@', '3814200202', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (828, 'Marley-Armatrad', 'marley.armatrad', '631747546', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (608, 'Moe-Weaver', 'm.weaver@tropic', '3123465756', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (486, 'Darius-Hector', 'darius.hector@w', '4048366738', 30);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (858, 'Kylie-Hannah', 'khannah@nsd.uk', '686745645', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (984, 'Arturo-Lawrence', 'arturo@ataservi', '2412447104', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (935, 'Bobbi-Sawa', 'bobbi.sawa@univ', '551178982', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (949, 'Blair-Briscoe', 'blair.briscoe@s', '3656062995', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (498, 'Carole-Dillane', 'c.dillane@kello', '2808736567', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (434, 'Barry-Colon', 'barry.colon@ape', '2142183790', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (849, 'Matt-Stigers', 'm.stigers@cis.c', '1319605181', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (36, 'Pam-Deejay', 'pam.deejay@cata', '2564457421', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (367, 'Carrie-Anne-Rai', 'crain@accuship.', '890380862', 30);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (390, 'Thin-Cattrall', 'thin.cattrall@k', '2383339312', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (21, 'Mel-Womack', 'mel.womack@worl', '2072319453', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (64, 'Jay-Lavigne', 'jay.lavigne@sm.', '1460552962', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (566, 'Lenny-Cook', 'lenny.cook@pra.', '1043731008', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (383, 'Roberta-Hobson', 'r.hobson@infini', '1697528263', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (534, 'Yolanda-Morriso', 'yolanda@telepoi', '2567153947', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (213, 'Raymond-Skarsga', 'rskarsgard@mont', '8163302', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (270, 'Juliette-Hayes', 'juliette.hayes@', '3131292085', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (444, 'Kevn-Warden', 'kevn.w@digitalm', '1369713939', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (236, 'Emma-Moraz', 'emma.moraz@staf', '1801105643', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (156, 'Brothers-Karyo', 'bkaryo@vspan.br', '582483459', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (472, 'Ivan-Fiorentino', 'i.fiorentino@pr', '786433786', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (622, 'Wes-Santana', 'wess@gagwear.pt', '706996003', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (854, 'Vince-Faithfull', 'vince@networkdi', '2669702203', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (908, 'Sal-Brandt', 'sal.brandt@well', '2679787434', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (797, 'Oded-McDowall', 'oded.mcdowall@h', '815587364', 30);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (258, 'Michael-Lloyd', 'michael@entelli', '522887581', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (412, 'Leon-Gough', 'leon.gough@mult', '2818252113', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (97, 'Vincent-Bell', 'vincent.bell@nr', '3960003655', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (378, 'Terence-Davies', 'terenced@neogen', '616946868', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (283, 'George-Peterson', 'george.peterson', '2274427089', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (790, 'Ozzy-Getty', 'ozzy@myricom.za', '3176876736', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (656, 'Marlon-Emmett', 'marlon.emmett@d', '2283472457', 30);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (291, 'Lois-Senior', 'lois.senior@anh', '2064143042', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (675, 'Dar-Mohr', 'dar.m@spenser.c', '2369182846', 30);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (365, 'James-Merchant', 'james.merchant@', '2057738767', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (994, 'Mitchell-Crysta', 'm.crystal@colga', '2762008759', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (633, 'Bobby-Brosnan', 'bobby.brosnan@t', '1776018292', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (282, 'Caroline-Prinze', 'caroline.prinze', '2533825955', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (401, 'Juliet-Choice', 'juliet.choice@f', '3081377274', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (946, 'Ashton-Duke', 'ashton.duke@evi', '3473133526', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (139, 'Jean-Claude-Bel', 'j.bello@pib.com', '3316388122', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (488, 'Horace-Reid', 'horacer@saralee', '1413001920', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (178, 'Brad-Lipnicki', 'bradl@sds.fi', '719219685', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (293, 'Bruce-Gibbons', 'bruce@ceom.com', '3216342117', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (386, 'Chi-Hamilton', 'chi.hamilton@og', '592020105', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (846, 'William-Eldard', 'william@verizon', '3693554284', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (844, 'Liquid-Allen', 'liquida@nsd.com', '3373563180', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (836, 'Andrae-Short', 'andrae.short@sh', '3470207940', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (976, 'Demi-Cheadle', 'demi.cheadle@bi', '1858364832', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (839, 'Avril-Hingle', 'avril@priorityl', '566344697', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (589, 'Bridgette-Nelli', 'bridgette@fetch', '3353572319', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (408, 'Lila-Malone', 'lilam@studiobpr', '1636792009', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (100, 'Lonnie-Aiken', 'lonniea@kiamoto', '3289217596', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (533, 'Deborah-Cusack', 'deborah.cusack@', '982898859', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (316, 'Malcolm-Judd', 'malcolm.judd@ab', '714922900', 40);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (840, 'Charles-Loeb', 'charles.loeb@ds', '1486084953', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (747, 'Amanda-Phillips', 'amanda.phillips', '2006003891', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (99, 'Delroy-Curtis', 'delroy.curtis@i', '3819054809', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (631, 'Brittany-Curtis', 'brittany.curtis', '3075190623', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (740, 'Jesus-Skaggs', 'jesus.skaggs@ax', '3272970185', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (77, 'Nikka-Pfeiffer', 'nikka.pfeiffer@', '2298696546', 30);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (757, 'Thomas-Eckhart', 'thomas.eckhart@', '3696969188', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (346, 'Keith-Leary', 'keith@randomwal', '2523510879', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (865, 'Rosco-Davies', 'rosco.davies@kn', '2700513590', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (330, 'Balthazar-Jonze', 'balthazar.jonze', '2030038165', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (705, 'Ned-Redford', 'nredford@consul', '4123302985', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (749, 'Rebecca-Gere', 'rebecca.gere@in', '1777909269', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (852, 'Bette-Schiff', 'bette.schiff@st', '2074778849', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (487, 'Rip-Hyde', 'rip.hyde@contra', '4260512493', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (275, 'Giovanni-Cherry', 'giovanni.cherry', '766562289', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (349, 'Joshua-Donelly', 'joshua.donelly@', '895025102', 0);
commit;
prompt 300 records committed...
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (425, 'Gord-Monk', 'gord.monk@alter', '3195468446', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (528, 'Vickie-Fierstei', 'vickie.fierstei', '3949064355', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (972, 'Alec-Zappacosta', 'alec.zappacosta', '59116495', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (66, 'Clint-Gill', 'c.gill@globalwi', '835908787', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (635, 'Lily-Charles', 'l.charles@infov', '3656099963', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (975, 'Kelli-Evett', 'kelli.evett@ubp', '3789692440', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (299, 'Joanna-Cochran', 'joannac@priorit', '2481349511', 30);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (117, 'Jeremy-Venora', 'jeremy@calence.', '2657913434', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (554, 'Ned-Manning', 'ned.manning@uni', '1995340926', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (824, 'Goran-Neville', 'goran.neville@m', '2374007156', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (939, 'Jeremy-Griffith', 'jeremy.griffith', '3647317442', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (26, 'Jay-Tyson', 'jayt@aoltimewar', '1483329094', 30);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (499, 'Freda-Dillane', 'freda.dillane@t', '1676862361', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (599, 'Vickie-Lewin', 'vickie.lewin@as', '4030853967', 30);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (368, 'Wally-Magnuson', 'wally.magnuson@', '1075591363', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (287, 'Lydia-Derringer', 'lderringer@bene', '1731560776', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (527, 'Freddy-Rucker', 'freddyr@timevis', '821845631', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (65, 'Sigourney-Phill', 'sphillips@summi', '1596348976', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (931, 'Chuck-Hiatt', 'chuck.hiatt@nor', '2124018733', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (462, 'Armin-Olin', 'armin.olin@joll', '2686232973', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (415, 'Olga-Goodall', 'olga.goodall@ar', '1174497826', 30);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (167, 'Andrew-Daniels', 'andrewd@gagwear', '971733588', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (603, 'Sigourney-Wooda', 'sigourney.w@sol', '4232171588', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (977, 'Joanna-Coverdal', 'joanna.c@team.c', '4113323463', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (729, 'Aida-Perlman', 'aida.perlman@ca', '1602615407', 0);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (497, 'Lynette-McDonal', 'lynette.mcdonal', '3534369884', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (5, 'Nicolas-Keaton', 'nicolas.keaton@', '1929378273', 20);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (137, 'Kiefer-Lennox', 'kiefer.lennox@z', '1678542245', 10);
insert into CUSTOMER (cid, cname, cemail, cphone, loyaltypoints)
values (15, 'Mike-McGriff', 'mikem@fetchlogi', '2654265182', 0);
commit;
...
insert into ORDERS (oid, orderdate, returndate, eid, did, cid, salary)
values (36, to_date('22-05-2022', 'dd-mm-yyyy'), to_date('22-12-2022', 'dd-mm-yyyy'), 109, 320, 299, null);
insert into ORDERS (oid, orderdate, returndate, eid, did, cid, salary)
values (31, to_date('22-05-2022', 'dd-mm-yyyy'), to_date('22-12-2022', 'dd-mm-yyyy'), 109, 320, 299, 150);
insert into ORDERS (oid, orderdate, returndate, eid, did, cid, salary)
values (200, to_date('07-07-2024 00:06:17', 'dd-mm-yyyy hh24:mi:ss'), to_date('12-07-2024 00:06:17', 'dd-mm-yyyy hh24:mi:ss'), 116, 506, 575, null);
insert into ORDERS (oid, orderdate, returndate, eid, did, cid, salary)
values (966, to_date('07-07-2024 00:09:06', 'dd-mm-yyyy hh24:mi:ss'), to_date('12-07-2024 00:09:06', 'dd-mm-yyyy hh24:mi:ss'), 116, 506, 575, 195);
insert into ORDERS (oid, orderdate, returndate, eid, did, cid, salary)
values (329, to_date('07-07-2024 00:13:04', 'dd-mm-yyyy hh24:mi:ss'), to_date('12-07-2024 00:13:04', 'dd-mm-yyyy hh24:mi:ss'), 116, 506, 575, 100);
insert into ORDERS (oid, orderdate, returndate, eid, did, cid, salary)
values (18, to_date('07-07-2024 00:15:13', 'dd-mm-yyyy hh24:mi:ss'), to_date('10-07-2024 00:15:24', 'dd-mm-yyyy hh24:mi:ss'), 116, 506, 575, 191);
insert into ORDERS (oid, orderdate, returndate, eid, did, cid, salary)
values (496, to_date('07-07-2024 00:18:42', 'dd-mm-yyyy hh24:mi:ss'), to_date('10-07-2024 00:18:43', 'dd-mm-yyyy hh24:mi:ss'), 110, 284, 756, 179);
insert into ORDERS (oid, orderdate, returndate, eid, did, cid, salary)
values (569, to_date('07-07-2024 00:49:16', 'dd-mm-yyyy hh24:mi:ss'), to_date('10-07-2024 00:49:16', 'dd-mm-yyyy hh24:mi:ss'), 110, 284, 756, 179);
insert into ORDERS (oid, orderdate, returndate, eid, did, cid, salary)
values (880, to_date('07-07-2024 16:38:30', 'dd-mm-yyyy hh24:mi:ss'), to_date('09-07-2024 16:38:30', 'dd-mm-yyyy hh24:mi:ss'), 104, 340, 462, 34);
insert into ORDERS (oid, orderdate, returndate, eid, did, cid, salary)
values (95, to_date('07-07-2024 16:38:37', 'dd-mm-yyyy hh24:mi:ss'), to_date('10-07-2024 16:38:37', 'dd-mm-yyyy hh24:mi:ss'), 113, 599, 341, 55);
insert into ORDERS (oid, orderdate, returndate, eid, did, cid, salary)
values (421, to_date('07-07-2024 16:40:11', 'dd-mm-yyyy hh24:mi:ss'), to_date('09-07-2024 16:40:11', 'dd-mm-yyyy hh24:mi:ss'), 120, 219, 64, 200);
insert into ORDERS (oid, orderdate, returndate, eid, did, cid, salary)
values (797, to_date('07-07-2024 16:40:32', 'dd-mm-yyyy hh24:mi:ss'), to_date('10-07-2024 16:40:32', 'dd-mm-yyyy hh24:mi:ss'), 123, 143, 162, 54);
insert into ORDERS (oid, orderdate, returndate, eid, did, cid, salary)
values (373, to_date('07-07-2024 18:17:36', 'dd-mm-yyyy hh24:mi:ss'), to_date('09-07-2024 18:17:36', 'dd-mm-yyyy hh24:mi:ss'), 109, 937, 287, 200);
insert into ORDERS (oid, orderdate, returndate, eid, did, cid, salary)
values (882, to_date('07-07-2024 18:21:48', 'dd-mm-yyyy hh24:mi:ss'), to_date('10-07-2024 18:21:48', 'dd-mm-yyyy hh24:mi:ss'), 117, 280, 959, 116);
insert into ORDERS (oid, orderdate, returndate, eid, did, cid, salary)
values (401, to_date('07-07-2024 18:24:37', 'dd-mm-yyyy hh24:mi:ss'), to_date('09-07-2024 18:24:37', 'dd-mm-yyyy hh24:mi:ss'), 117, 280, 959, 144);
insert into ORDERS (oid, orderdate, returndate, eid, did, cid, salary)
values (954, to_date('07-07-2024 18:26:04', 'dd-mm-yyyy hh24:mi:ss'), to_date('09-07-2024 18:26:04', 'dd-mm-yyyy hh24:mi:ss'), 117, 102, 959, 144);
insert into ORDERS (oid, orderdate, returndate, eid, did, cid, salary)
values (634, to_date('07-07-2024 18:36:09', 'dd-mm-yyyy hh24:mi:ss'), to_date('12-07-2024 18:36:09', 'dd-mm-yyyy hh24:mi:ss'), 109, 451, 108, 163);
insert into ORDERS (oid, orderdate, returndate, eid, did, cid, salary)
values (654, to_date('07-07-2024 18:42:22', 'dd-mm-yyyy hh24:mi:ss'), to_date('10-07-2024 18:42:22', 'dd-mm-yyyy hh24:mi:ss'), 106, 280, 138, 190);
insert into ORDERS (oid, orderdate, returndate, eid, did, cid, salary)
values (636, to_date('07-07-2024 18:47:18', 'dd-mm-yyyy hh24:mi:ss'), to_date('10-07-2024 18:47:18', 'dd-mm-yyyy hh24:mi:ss'), 122, 617, 389, 198);
insert into ORDERS (oid, orderdate, returndate, eid, did, cid, salary)
...
insert into PAYMENT (pid, price, ispaid, fineprice, oid)
values (100, 887, 0, 0, 762);
insert into PAYMENT (pid, price, ispaid, fineprice, oid)
values (101, 766, 0, 0, 36);
insert into PAYMENT (pid, price, ispaid, fineprice, oid)
values (102, 766, 0, 0, 31);
insert into PAYMENT (pid, price, ispaid, fineprice, oid)
values (162, 924, 0, 0, 200);
insert into PAYMENT (pid, price, ispaid, fineprice, oid)
values (655, 924, 0, 0, 966);
insert into PAYMENT (pid, price, ispaid, fineprice, oid)
values (858, 924, 0, 0, 329);
insert into PAYMENT (pid, price, ispaid, fineprice, oid)
values (213, 924, 0, 0, 18);
insert into PAYMENT (pid, price, ispaid, fineprice, oid)
values (230, 864, 0, 0, 496);
insert into PAYMENT (pid, price, ispaid, fineprice, oid)
values (85, 894, 0, 0, 569);
insert into PAYMENT (pid, price, ispaid, fineprice, oid)
values (635, 171, 0, 0, 880);
insert into PAYMENT (pid, price, ispaid, fineprice, oid)
values (770, 276, 0, 0, 95);
insert into PAYMENT (pid, price, ispaid, fineprice, oid)
values (273, 999, 0, 0, 421);
insert into PAYMENT (pid, price, ispaid, fineprice, oid)
values (676, 268, 0, 0, 797);
insert into PAYMENT (pid, price, ispaid, fineprice, oid)
values (612, 999, 0, 0, 373);
insert into PAYMENT (pid, price, ispaid, fineprice, oid)
values (515, 580, 0, 0, 882);
insert into PAYMENT (pid, price, ispaid, fineprice, oid)
values (302, 720, 0, 0, 401);
insert into PAYMENT (pid, price, ispaid, fineprice, oid)
values (431, 720, 0, 0, 954);
insert into PAYMENT (pid, price, ispaid, fineprice, oid)
values (385, 817, 0, 0, 634);
insert into PAYMENT (pid, price, ispaid, fineprice, oid)
values (962, 950, 0, 0, 654);
insert into PAYMENT (pid, price, ispaid, fineprice, oid)
values (748, 991, 0, 0, 636);
insert into PAYMENT (pid, price, ispaid, fineprice, oid)
...
alter table ORDERS enable constraint SYS_C007225;
alter table ORDERS enable constraint SYS_C007226;
alter table ORDERS enable constraint SYS_C007227;
prompt Enabling foreign key constraints for LAUNDRY...
alter table LAUNDRY enable constraint SYS_C007241;
prompt Enabling foreign key constraints for PAYMENT...
alter table PAYMENT enable constraint SYS_C007235;
